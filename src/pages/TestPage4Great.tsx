...
export function TestPage4() {
  ...
  //const queryRef = useLoaderData() as QueryRefType; Use this
  ...
  /*const { data, fetchMore } = useQuery(GET_TRANSACTIONS, {
    variables: {
      offset: currentIndex,
      limit: limit,
    },
  ...
  const updateDisplayedTransactions = () => {
    ...
    console.log("newDisplayedTransactions: ", newDisplayedTransactions);
    console.groupEnd(); */
    }
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      // console.log("fetchMore transactions: ", getTransactions);
    } catch (error) {
  ...
  const handleNextClick = () => {
    startTransition(() => {
      ...
      //  if (newIndex >= transactions.length - 4 && hasMorePosts) {
      //console.log("hasMorePosts: ", hasMorePosts);
      if (newIndex >= transactions.length - 2 && hasMorePosts) {
  ...
  useEffect(() => {
    {
      /* console.log("useEffect to updateTransactions");
    console.log("transactions: ", transactions); */
    }
